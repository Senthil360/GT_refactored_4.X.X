...
if !build! EQU magisk (
	...
	:: TODO: Unbreak this.
	set expect_file="GovTuner_hybrid"
	ren "%home_dir\output\temp-magisk\system\etc\GovTuner\profiles\govtuner_hybrid" %home_dir%\output\temp-magisk\system\etc\GovTuner\profiles\!expect_file!
